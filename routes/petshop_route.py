...
@PETSHOP_ROUTE.route('/update/petshop/<petshop_id:str>/', methods=['PUT', 'GET'])
...
@PETSHOP_ROUTE.route('patch/petshop/<petshop_id:str>/', methods=['PATCH', 'GET'])
async def patch_petshop(request: Request, petshop_id:str):
    try:
